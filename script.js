...
productData.forEach(element => {
       ...
       const featuredImgDark = document.createElement('div');
       featuredImgDark.classList.add('featuredImgDark');
       ...
       featuredImgDark.appendChild(addToCart);
       containerImg.appendChild(productImg);
       containerImg.appendChild(featuredImgDark);
  ...
  document.querySelector(".product_cards").addEventListener("click", (event) => {
  ...
  function getBasketProductMarkup(product) {
    return `
      <div class="basketRow" data-id="${product.id}">
        ...
        <div>
             <button class="productRemove">-</button>
        </div>
      </div>
    `;
  }
